...
Revision ID: 639f004a4d05
Revises: 
Create Date: 2019-08-06 15:10:12.209484
...
def upgrade():
    ...
    sa.Column('special_notices', sa.Text(), nullable=False),
    sa.Column('status', sa.SmallInteger(), nullable=False),
    sa.Column('max_guess', sa.Integer(), nullable=False),
    sa.Column('num_bathrooms', sa.SmallInteger(), nullable=False),
    sa.Column('num_bedrooms', sa.SmallInteger(), nullable=False),
    sa.Column('num_beds', sa.SmallInteger(), nullable=False),
    sa.Column('apartment_manual', sa.Text(), nullable=False),
    sa.Column('apartment_rule', sa.Text(), nullable=False),
    sa.Column('direction_manual', sa.Text(), nullable=False),
    sa.Column('checkin_guide', sa.Text(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('member_id', sa.String(length=36), nullable=True),
    sa.Column('accommodation_id', sa.String(length=36), nullable=True),
